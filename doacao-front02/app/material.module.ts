...
import {
    ...
    MatFormField, MatFormFieldModule, MatProgressSpinnerModule, MatInputModule, MAT_DATE_LOCALE
...
@NgModule({
    ...
    exports: [MatTabsModule, MatDividerModule, MatSliderModule, MatSelectModule,
        ...
        MatTabsModule, MatFormFieldModule, MatProgressSpinnerModule, MatInputModule, MatPaginatorModule],
    providers: [
